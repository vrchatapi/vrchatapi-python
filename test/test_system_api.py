...
import vrchatapi
from vrchatapi.api.system_api import SystemApi  # noqa: E501
...
class TestSystemApi(unittest.TestCase):
    ...
    def test_get_current_online_users(self):
        """Test case for get_current_online_users
