...
class FollowCalendarEventRequest(object):
    ...
    def __init__(self, is_following=None, local_vars_configuration=None):  # noqa: E501
        """FollowCalendarEventRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def is_following(self):
        """Gets the is_following of this FollowCalendarEventRequest.  # noqa: E501


        :return: The is_following of this FollowCalendarEventRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_following(self, is_following):
        """Sets the is_following of this FollowCalendarEventRequest.


        :param is_following: The is_following of this FollowCalendarEventRequest.  # noqa: E501
        :type is_following: bool
        """
        if self.local_vars_configuration.client_side_validation and is_following is None:  # noqa: E501
            raise ValueError("Invalid value for `is_following`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FollowCalendarEventRequest):
            return False
