...
class APIConfigReportCategories(object):
    ...
    def __init__(self, avatar=None, behavior=None, chat=None, emoji=None, environment=None, groupstore=None, image=None, text=None, sticker=None, warnings=None, worldimage=None, worldstore=None, local_vars_configuration=None):  # noqa: E501
