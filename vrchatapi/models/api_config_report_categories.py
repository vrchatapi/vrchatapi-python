...
class APIConfigReportCategories(object):
    ...
    def __init__(self, avatar=None, behavior=None, chat=None, environment=None, groupstore=None, image=None, text=None, warnings=None, worldimage=None, worldstore=None, local_vars_configuration=None):  # noqa: E501
