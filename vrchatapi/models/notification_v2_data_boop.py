...
class NotificationV2DataBoop(object):
    ...
    def __init__(self, booping_user_display_name=None, local_vars_configuration=None):  # noqa: E501
        """NotificationV2DataBoop - a model defined in OpenAPI"""  # noqa: E501
    ...
    def booping_user_display_name(self):
        """Gets the booping_user_display_name of this NotificationV2DataBoop.  # noqa: E501


        :return: The booping_user_display_name of this NotificationV2DataBoop.  # noqa: E501
        :rtype: str
        """
    ...
    def booping_user_display_name(self, booping_user_display_name):
        """Sets the booping_user_display_name of this NotificationV2DataBoop.


        :param booping_user_display_name: The booping_user_display_name of this NotificationV2DataBoop.  # noqa: E501
        :type booping_user_display_name: str
        """
        if self.local_vars_configuration.client_side_validation and booping_user_display_name is None:  # noqa: E501
            raise ValueError("Invalid value for `booping_user_display_name`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotificationV2DataBoop):
            return False
