...
class CreateGroupRequest(object):
    ...
    def __init__(self, banner_id=None, description=None, icon_id=None, join_state=None, name=None, privacy=None, role_template=None, short_code=None, local_vars_configuration=None):  # noqa: E501
