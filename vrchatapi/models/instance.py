...
class Instance(object):
    ...
    def role_restricted(self, role_restricted):
        ...
        """
        if self.local_vars_configuration.client_side_validation and role_restricted is None:  # noqa: E501
            raise ValueError("Invalid value for `role_restricted`, must not be `None`")  # noqa: E501
