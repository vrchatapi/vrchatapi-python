...
class UpdateAvatarRequest(object):
    ...
    def __init__(self, asset_url=None, description=None, id=None, image_url=None, name=None, release_status=None, tags=None, unity_package_url=None, unity_version='5.3.4p1', version=1, local_vars_configuration=None):  # noqa: E501
