...
class UpdateAvatarRequest(object):
    ...
    def __init__(self, asset_url=None, id=None, name=None, description=None, tags=None, image_url=None, release_status=None, version=1, unity_package_url=None, unity_version='5.3.4p1', local_vars_configuration=None):  # noqa: E501
