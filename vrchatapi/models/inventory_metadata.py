...
class InventoryMetadata(object):
    ...
    def __init__(self, animated=None, animation_style=None, asset_bundle_id=None, file_id=None, image_url=None, inventory_items_to_instantiate=None, mask_tag=None, prop_id=None, local_vars_configuration=None):  # noqa: E501
