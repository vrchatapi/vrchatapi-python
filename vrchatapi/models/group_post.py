...
class GroupPost(object):
    ...
    def __init__(self, author_id=None, created_at=None, editor_id=None, group_id=None, id=None, image_id=None, image_url=None, role_id=None, text=None, title=None, updated_at=None, visibility=None, local_vars_configuration=None):  # noqa: E501
