...
class UpdateUserRequest(object):
    ...
    def __init__(self, email=None, birthday=None, accepted_tos_version=None, tags=None, status=None, status_description=None, bio=None, bio_links=None, pronouns=None, user_icon=None, local_vars_configuration=None):  # noqa: E501
