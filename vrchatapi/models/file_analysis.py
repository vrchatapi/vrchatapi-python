...
class FileAnalysis(object):
    ...
    def __init__(self, avatar_stats=None, created_at=None, file_size=None, performance_rating=None, success=None, uncompressed_size=None, local_vars_configuration=None):  # noqa: E501
