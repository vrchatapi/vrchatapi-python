...
class Transaction(object):
    ...
    def __init__(self, agreement=None, created_at=None, error=None, id=None, is_gift=False, is_tokens=False, sandbox=False, status=None, steam=None, subscription=None, updated_at=None, user_display_name=None, user_id=None, local_vars_configuration=None):  # noqa: E501
