...
class CreateAvatarRequest(object):
    ...
    def __init__(self, asset_url=None, asset_version=None, created_at=None, description=None, id=None, image_url=None, name=None, platform=None, release_status=None, tags=None, thumbnail_image_url=None, unity_package_url=None, unity_version='5.3.4p1', updated_at=None, version=1, local_vars_configuration=None):  # noqa: E501
