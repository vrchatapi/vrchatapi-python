...
class APIConfigEvents(object):
    ...
    openapi_types = {
        ...
        'use_sparse_rotation_for_player_serialization': 'bool',
    ...
    def __init__(self, distance_close=None, distance_factor=None, distance_far=None, group_distance=None, maximum_bunch_size=None, not_visible_factor=None, player_order_bucket_size=None, player_order_factor=None, slow_update_factor_threshold=None, use_direct_player_serialization=None, use_sparse_rotation_for_player_serialization=None, view_segment_length=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._use_direct_player_serialization = None
        self._use_sparse_rotation_for_player_serialization = None
        ...
        self.use_direct_player_serialization = use_direct_player_serialization
        if use_sparse_rotation_for_player_serialization is not None:
            self.use_sparse_rotation_for_player_serialization = use_sparse_rotation_for_player_serialization
    ...
    @property
    def use_direct_player_serialization(self):
        """Gets the use_direct_player_serialization of this APIConfigEvents.  # noqa: E501

        Unknown  # noqa: E501

        :return: The use_direct_player_serialization of this APIConfigEvents.  # noqa: E501
        :rtype: bool
        """
        return self._use_direct_player_serialization

    @use_direct_player_serialization.setter
    def use_direct_player_serialization(self, use_direct_player_serialization):
        """Sets the use_direct_player_serialization of this APIConfigEvents.

        Unknown  # noqa: E501

        :param use_direct_player_serialization: The use_direct_player_serialization of this APIConfigEvents.  # noqa: E501
        :type use_direct_player_serialization: bool
        """
        if self.local_vars_configuration.client_side_validation and use_direct_player_serialization is None:  # noqa: E501
            raise ValueError("Invalid value for `use_direct_player_serialization`, must not be `None`")  # noqa: E501

        self._use_direct_player_serialization = use_direct_player_serialization

    @property
    def use_sparse_rotation_for_player_serialization(self):
        """Gets the use_sparse_rotation_for_player_serialization of this APIConfigEvents.  # noqa: E501


        :return: The use_sparse_rotation_for_player_serialization of this APIConfigEvents.  # noqa: E501
        :rtype: bool
        """
        return self._use_sparse_rotation_for_player_serialization

    @use_sparse_rotation_for_player_serialization.setter
    def use_sparse_rotation_for_player_serialization(self, use_sparse_rotation_for_player_serialization):
        """Sets the use_sparse_rotation_for_player_serialization of this APIConfigEvents.


        :param use_sparse_rotation_for_player_serialization: The use_sparse_rotation_for_player_serialization of this APIConfigEvents.  # noqa: E501
        :type use_sparse_rotation_for_player_serialization: bool
        """

        self._use_sparse_rotation_for_player_serialization = use_sparse_rotation_for_player_serialization
