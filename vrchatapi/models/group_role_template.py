...
class GroupRoleTemplate(object):
    ...
    allowable_values = [DEFAULT, MANAGEDFREE, MANAGEDINVITE, MANAGEDREQUEST]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GroupRoleTemplate - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupRoleTemplate):
            return False
