...
class World(object):
    ...
    def __init__(self, author_id=None, author_name=None, capacity=None, created_at=None, default_content_settings=None, description=None, disabled_prop_abilities=None, favorites=0, featured=False, heat=0, id=None, image_url=None, instances=None, is_hype_train_eligible=None, labs_publication_date=None, name=None, namespace=None, occupants=0, organization='vrchat', popularity=0, preview_youtube_id=None, private_occupants=0, public_occupants=0, publication_date=None, recommended_capacity=None, release_status=None, slim_instances=None, store_id=None, tags=None, thumbnail_image_url=None, udon_products=None, unity_packages=None, updated_at=None, url_list=None, version=0, visits=0, local_vars_configuration=None):  # noqa: E501
        ...
        if slim_instances is not None:
            self.slim_instances = slim_instances
    ...
    def disabled_prop_abilities(self):
        """Gets the disabled_prop_abilities of this World.  # noqa: E501


        :return: The disabled_prop_abilities of this World.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def disabled_prop_abilities(self, disabled_prop_abilities):
        """Sets the disabled_prop_abilities of this World.


        :param disabled_prop_abilities: The disabled_prop_abilities of this World.  # noqa: E501
    ...
    @property
    def slim_instances(self):
        """Gets the slim_instances of this World.  # noqa: E501


        :return: The slim_instances of this World.  # noqa: E501
        :rtype: list[object]
        """
        return self._slim_instances

    @slim_instances.setter
    def slim_instances(self, slim_instances):
        """Sets the slim_instances of this World.


        :param slim_instances: The slim_instances of this World.  # noqa: E501
        :type slim_instances: list[object]
        """

        self._slim_instances = slim_instances
