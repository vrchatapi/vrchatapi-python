...
class MIMEType(object):
    ...
    allowable_values = [APPLICATION_GZIP, APPLICATION_OCTET_STREAM, APPLICATION_X_AVATAR, APPLICATION_X_RSYNC_DELTA, APPLICATION_X_RSYNC_SIGNATURE, APPLICATION_X_WORLD, IMAGE_BMP, IMAGE_GIF, IMAGE_JPEG, IMAGE_JPG, IMAGE_PNG, IMAGE_SVG_XML, IMAGE_TIFF, IMAGE_WEBP]  # noqa: E501
