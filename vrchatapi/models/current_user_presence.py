...
class CurrentUserPresence(object):
    ...
    def __init__(self, avatar_thumbnail=None, current_avatar_tags=None, debugflag=None, display_name=None, groups=None, id=None, instance=None, instance_type=None, is_rejoining=None, platform=None, profile_pic_override=None, status=None, traveling_to_instance=None, traveling_to_world=None, user_icon=None, world=None, local_vars_configuration=None):  # noqa: E501
