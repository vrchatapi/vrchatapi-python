...
class InfoPushData(object):
    ...
    def __init__(self, article=None, content_list=None, description=None, image_url=None, name=None, on_pressed=None, template=None, version=None, local_vars_configuration=None):  # noqa: E501
