...
class TwoFactorAuthType(object):
    ...
    allowable_values = [EMAILOTP, OTP, TOTP]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """TwoFactorAuthType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TwoFactorAuthType):
            return False
