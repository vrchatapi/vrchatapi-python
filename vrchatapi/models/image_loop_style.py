...
class ImageLoopStyle(object):
    ...
    allowable_values = [LINEAR, PINGPONG]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ImageLoopStyle - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImageLoopStyle):
            return False
