...
class LimitedUserInstance(object):
    ...
    def __init__(self, age_verification_status=None, age_verified=None, allow_avatar_copying=None, bio=None, bio_links=None, current_avatar_image_url=None, current_avatar_thumbnail_image_url=None, current_avatar_tags=None, date_joined=None, developer_type=None, display_name=None, friend_key=None, id=None, is_friend=None, image_url=None, last_platform=None, last_activity=None, last_mobile=None, platform=None, profile_pic_override=None, profile_pic_override_thumbnail=None, pronouns=None, state=None, status=None, status_description=None, tags=None, user_icon=None, local_vars_configuration=None):  # noqa: E501
