...
class Group(object):
    ...
    def __init__(self, badges=None, id=None, name=None, short_code=None, discriminator=None, description=None, icon_url=None, banner_url=None, privacy=None, owner_id=None, rules=None, links=None, languages=None, icon_id=None, banner_id=None, member_count=None, member_count_synced_at=None, is_verified=False, join_state=None, tags=None, transfer_target_id=None, galleries=None, created_at=None, updated_at=None, last_post_created_at=None, online_member_count=None, membership_status=None, my_member=None, roles=None, local_vars_configuration=None):  # noqa: E501
