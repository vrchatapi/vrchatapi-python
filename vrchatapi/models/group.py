...
class Group(object):
    ...
    def __init__(self, age_verification_beta_code=None, age_verification_beta_slots=None, age_verification_slots_available=None, allow_group_join_prompt=None, badges=None, banner_id=None, banner_url=None, created_at=None, description=None, discriminator=None, galleries=None, icon_id=None, icon_url=None, id=None, is_verified=False, join_state=None, languages=None, last_post_created_at=None, links=None, member_count=None, member_count_synced_at=None, membership_status=None, my_member=None, name=None, online_member_count=None, owner_id=None, privacy=None, roles=None, rules=None, short_code=None, tags=None, transfer_target_id=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
