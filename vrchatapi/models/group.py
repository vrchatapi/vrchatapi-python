...
class Group(object):
    ...
    def __init__(self, age_verification_beta_code=None, age_verification_beta_slots=None, age_verification_slots_available=None, allow_group_join_prompt=None, badges=None, banner_id=None, banner_url=None, created_at=None, description=None, discriminator=None, galleries=None, icon_id=None, icon_url=None, id=None, is_verified=False, join_state=None, languages=None, last_post_created_at=None, links=None, member_count=None, member_count_synced_at=None, membership_status=None, my_member=None, name=None, nameplate_id=None, nameplate_url=None, online_member_count=None, owner_id=None, privacy=None, roles=None, rules=None, short_code=None, store_id=None, tags=None, transfer_target_id=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._allow_group_join_prompt = None
        self._badges = None
        ...
        if allow_group_join_prompt is not None:
            self.allow_group_join_prompt = allow_group_join_prompt
    ...
    @property
    def allow_group_join_prompt(self):
        """Gets the allow_group_join_prompt of this Group.  # noqa: E501


        :return: The allow_group_join_prompt of this Group.  # noqa: E501
        :rtype: bool
        """
        return self._allow_group_join_prompt

    @allow_group_join_prompt.setter
    def allow_group_join_prompt(self, allow_group_join_prompt):
        """Sets the allow_group_join_prompt of this Group.


        :param allow_group_join_prompt: The allow_group_join_prompt of this Group.  # noqa: E501
        :type allow_group_join_prompt: bool
        """

        self._allow_group_join_prompt = allow_group_join_prompt
    ...
    def nameplate_id(self):
        """Gets the nameplate_id of this Group.  # noqa: E501

        An unknown value. Consider [contributing](https://vrchat.community/contributing).  # noqa: E501

        :return: The nameplate_id of this Group.  # noqa: E501
        :rtype: object
        """
    ...
    def nameplate_id(self, nameplate_id):
        """Sets the nameplate_id of this Group.

        An unknown value. Consider [contributing](https://vrchat.community/contributing).  # noqa: E501

        :param nameplate_id: The nameplate_id of this Group.  # noqa: E501
    ...
    def nameplate_url(self):
        """Gets the nameplate_url of this Group.  # noqa: E501

        An unknown value. Consider [contributing](https://vrchat.community/contributing).  # noqa: E501

        :return: The nameplate_url of this Group.  # noqa: E501
        :rtype: object
        """
    ...
    def nameplate_url(self, nameplate_url):
        """Sets the nameplate_url of this Group.

        An unknown value. Consider [contributing](https://vrchat.community/contributing).  # noqa: E501

        :param nameplate_url: The nameplate_url of this Group.  # noqa: E501
