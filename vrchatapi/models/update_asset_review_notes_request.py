...
class UpdateAssetReviewNotesRequest(object):
    ...
    def __init__(self, review_notes=None, local_vars_configuration=None):  # noqa: E501
        """UpdateAssetReviewNotesRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def review_notes(self):
        """Gets the review_notes of this UpdateAssetReviewNotesRequest.  # noqa: E501


        :return: The review_notes of this UpdateAssetReviewNotesRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def review_notes(self, review_notes):
        """Sets the review_notes of this UpdateAssetReviewNotesRequest.


        :param review_notes: The review_notes of this UpdateAssetReviewNotesRequest.  # noqa: E501
        :type review_notes: str
        """
        if self.local_vars_configuration.client_side_validation and review_notes is None:  # noqa: E501
            raise ValueError("Invalid value for `review_notes`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAssetReviewNotesRequest):
            return False
