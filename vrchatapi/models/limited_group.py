...
class LimitedGroup(object):
    ...
    def __init__(self, banner_id=None, banner_url=None, created_at=None, description=None, discriminator=None, galleries=None, icon_id=None, icon_url=None, id=None, is_searchable=None, member_count=None, membership_status=None, name=None, owner_id=None, rules=None, short_code=None, tags=None, local_vars_configuration=None):  # noqa: E501
