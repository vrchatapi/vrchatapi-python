...
class PlayerModerationType(object):
    ...
    allowable_values = [BLOCK, HIDEAVATAR, INTERACTOFF, INTERACTON, MUTE, MUTECHAT, SHOWAVATAR, UNMUTE, UNMUTECHAT]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """PlayerModerationType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlayerModerationType):
            return False
