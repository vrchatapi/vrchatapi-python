...
class GroupRole(object):
    ...
    def __init__(self, created_at=None, description=None, group_id=None, id=None, is_management_role=False, is_self_assignable=False, name=None, order=None, permissions=None, requires_purchase=False, requires_two_factor=False, updated_at=None, local_vars_configuration=None):  # noqa: E501
