...
class Notification(object):
    ...
    def __init__(self, created_at=None, details='{}', id=None, message=None, receiver_user_id=None, seen=False, sender_user_id=None, sender_username=None, type=None, local_vars_configuration=None):  # noqa: E501
    ...
    def sender_username(self):
        ...
        The name of the user who sent the notification.  # noqa: E501
