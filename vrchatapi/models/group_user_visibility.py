...
class GroupUserVisibility(object):
    ...
    allowable_values = [FRIENDS, HIDDEN, VISIBLE]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GroupUserVisibility - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupUserVisibility):
            return False
