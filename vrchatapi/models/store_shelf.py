...
class StoreShelf(object):
    ...
    def __init__(self, highlight_listing=None, highlight_listing_id=None, id=None, listing_ids=None, listings=None, shelf_description=None, shelf_layout=None, shelf_title=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
