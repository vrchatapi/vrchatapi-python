...
class StoreShelf(object):
    ...
    def __init__(self, highlight_listing=None, highlight_listing_id=None, id=None, listing_ids=None, listings=None, shelf_background_image_id=None, shelf_client_banner_image_id=None, shelf_description=None, shelf_icon_image_id=None, shelf_layout=None, shelf_mobile_hero_banner_image_id=None, shelf_mobile_logo_image_id=None, shelf_mobile_secondary_banner_image_id=None, shelf_tab_background_image_id=None, shelf_title=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._highlight_listing = None
        self._highlight_listing_id = None
        self._id = None
        ...
        if highlight_listing is not None:
            self.highlight_listing = highlight_listing
        if highlight_listing_id is not None:
            self.highlight_listing_id = highlight_listing_id
        self.id = id
    ...
    def highlight_listing(self):
        """Gets the highlight_listing of this StoreShelf.  # noqa: E501


        :return: The highlight_listing of this StoreShelf.  # noqa: E501
        :rtype: ProductListing
        """
        return self._highlight_listing

    @highlight_listing.setter
    def highlight_listing(self, highlight_listing):
        """Sets the highlight_listing of this StoreShelf.


        :param highlight_listing: The highlight_listing of this StoreShelf.  # noqa: E501
        :type highlight_listing: ProductListing
        """

        self._highlight_listing = highlight_listing

    @property
    def highlight_listing_id(self):
        """Gets the highlight_listing_id of this StoreShelf.  # noqa: E501


        :return: The highlight_listing_id of this StoreShelf.  # noqa: E501
        :rtype: str
        """
        return self._highlight_listing_id

    @highlight_listing_id.setter
    def highlight_listing_id(self, highlight_listing_id):
        """Sets the highlight_listing_id of this StoreShelf.


        :param highlight_listing_id: The highlight_listing_id of this StoreShelf.  # noqa: E501
        :type highlight_listing_id: str
        """

        self._highlight_listing_id = highlight_listing_id
    ...
    @property
    def shelf_background_image_id(self):
        """Gets the shelf_background_image_id of this StoreShelf.  # noqa: E501


        :return: The shelf_background_image_id of this StoreShelf.  # noqa: E501
        :rtype: str
        """
        return self._shelf_background_image_id

    @shelf_background_image_id.setter
    def shelf_background_image_id(self, shelf_background_image_id):
        """Sets the shelf_background_image_id of this StoreShelf.


        :param shelf_background_image_id: The shelf_background_image_id of this StoreShelf.  # noqa: E501
        :type shelf_background_image_id: str
        """
    ...
    @property
    def shelf_icon_image_id(self):
        """Gets the shelf_icon_image_id of this StoreShelf.  # noqa: E501


        :return: The shelf_icon_image_id of this StoreShelf.  # noqa: E501
        :rtype: str
        """
        return self._shelf_icon_image_id

    @shelf_icon_image_id.setter
    def shelf_icon_image_id(self, shelf_icon_image_id):
        """Sets the shelf_icon_image_id of this StoreShelf.


        :param shelf_icon_image_id: The shelf_icon_image_id of this StoreShelf.  # noqa: E501
        :type shelf_icon_image_id: str
        """

        self._shelf_icon_image_id = shelf_icon_image_id
    ...
    def shelf_tab_background_image_id(self):
        """Gets the shelf_tab_background_image_id of this StoreShelf.  # noqa: E501


        :return: The shelf_tab_background_image_id of this StoreShelf.  # noqa: E501
        :rtype: str
        """
        return self._shelf_tab_background_image_id

    @shelf_tab_background_image_id.setter
    def shelf_tab_background_image_id(self, shelf_tab_background_image_id):
        """Sets the shelf_tab_background_image_id of this StoreShelf.


        :param shelf_tab_background_image_id: The shelf_tab_background_image_id of this StoreShelf.  # noqa: E501
        :type shelf_tab_background_image_id: str
        """

        self._shelf_tab_background_image_id = shelf_tab_background_image_id
