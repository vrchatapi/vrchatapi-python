...
class InventoryDrop(object):
    ...
    def __init__(self, author_id=None, created_at=None, drop_expiry_date=None, end_drop_date=None, id=None, is_disabled=None, name=None, notification_details=None, start_drop_date=None, status=None, tags=None, target_group=None, template_ids=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
