...
class GroupAnnouncement(object):
    ...
    def __init__(self, author_id=None, created_at=None, group_id=None, id=None, image_id=None, image_url=None, text=None, title=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
