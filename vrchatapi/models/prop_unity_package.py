...
class PropUnityPackage(object):
    ...
    def __init__(self, asset_url=None, asset_version=None, platform=None, prop_signature=None, unity_version='2022.3.22f1', variant=None, local_vars_configuration=None):  # noqa: E501
