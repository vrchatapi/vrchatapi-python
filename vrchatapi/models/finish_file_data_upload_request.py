...
class FinishFileDataUploadRequest(object):
    ...
    def next_part_number(self, next_part_number):
        ...
        if (self.local_vars_configuration.client_side_validation and
                next_part_number is not None and not re.search(r'0', next_part_number)):  # noqa: E501
            raise ValueError(r"Invalid value for `next_part_number`, must be a follow pattern or equal to `/0/`")  # noqa: E501
    ...
    def max_parts(self, max_parts):
        ...
        if (self.local_vars_configuration.client_side_validation and
                max_parts is not None and not re.search(r'0', max_parts)):  # noqa: E501
            raise ValueError(r"Invalid value for `max_parts`, must be a follow pattern or equal to `/0/`")  # noqa: E501
