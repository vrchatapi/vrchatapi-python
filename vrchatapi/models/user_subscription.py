...
class UserSubscription(object):
    ...
    def __init__(self, active=True, amount=None, created_at=None, description=None, expires=None, id=None, is_bulk_gift=False, is_gift=False, license_groups=None, period=None, starts=None, status=None, steam_item_id=None, store=None, tier=None, transaction_id=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
