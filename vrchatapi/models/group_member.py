...
class GroupMember(object):
    ...
    def __init__(self, accepted_by_display_name=None, accepted_by_id=None, id=None, group_id=None, user_id=None, is_representing=False, user=None, role_ids=None, m_role_ids=None, joined_at=None, membership_status=None, visibility=None, is_subscribed_to_announcements=False, is_subscribed_to_event_announcements=None, created_at=None, banned_at=None, manager_notes=None, last_post_read_at=None, has_joined_from_purchase=None, local_vars_configuration=None):  # noqa: E501
