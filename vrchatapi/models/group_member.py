...
class GroupMember(object):
    ...
    def __init__(self, accepted_by_display_name=None, accepted_by_id=None, banned_at=None, created_at=None, group_id=None, has_joined_from_purchase=None, id=None, is_representing=False, is_subscribed_to_announcements=False, is_subscribed_to_event_announcements=None, joined_at=None, last_post_read_at=None, m_role_ids=None, manager_notes=None, membership_status=None, role_ids=None, user=None, user_id=None, visibility=None, local_vars_configuration=None):  # noqa: E501
