...
class Subscription(object):
    ...
    def __init__(self, amount=None, apple_product_id=None, description=None, google_plan_id=None, google_product_id=None, id=None, oculus_sku=None, period=None, pico_sku=None, steam_item_id=None, tier=None, local_vars_configuration=None):  # noqa: E501
