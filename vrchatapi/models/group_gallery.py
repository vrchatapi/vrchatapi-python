...
class GroupGallery(object):
    ...
    def __init__(self, created_at=None, description=None, id=None, members_only=False, name=None, role_ids_to_auto_approve=None, role_ids_to_manage=None, role_ids_to_submit=None, role_ids_to_view=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
