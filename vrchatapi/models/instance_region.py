...
class InstanceRegion(object):
    ...
    allowable_values = [EU, JP, UNKNOWN, US, USE]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """InstanceRegion - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InstanceRegion):
            return False
