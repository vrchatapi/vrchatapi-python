...
class TransactionAgreement(object):
    ...
    def __init__(self, agreement=None, agreement_id=None, billing_type=None, currency=None, end_date=None, failed_attempts=None, frequency=None, item_id=None, last_amount=None, last_amount_vat=None, last_payment=None, next_payment=None, outstanding=None, period=None, recurring_amt=None, start_date=None, status=None, time_created=None, local_vars_configuration=None):  # noqa: E501
