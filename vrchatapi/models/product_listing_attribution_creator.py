...
class ProductListingAttributionCreator(object):
    ...
    def __init__(self, custom_name=None, user_id=None, local_vars_configuration=None):  # noqa: E501
        """ProductListingAttributionCreator - a model defined in OpenAPI"""  # noqa: E501
    ...
    def custom_name(self):
        """Gets the custom_name of this ProductListingAttributionCreator.  # noqa: E501


        :return: The custom_name of this ProductListingAttributionCreator.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_name(self, custom_name):
        """Sets the custom_name of this ProductListingAttributionCreator.


        :param custom_name: The custom_name of this ProductListingAttributionCreator.  # noqa: E501
    ...
    @property
    def user_id(self):
        """Gets the user_id of this ProductListingAttributionCreator.  # noqa: E501

        A users unique ID, usually in the form of `usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469`. Legacy players can have old IDs in the form of `8JoV9XEdpo`. The ID can never be changed.  # noqa: E501

        :return: The user_id of this ProductListingAttributionCreator.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this ProductListingAttributionCreator.

        A users unique ID, usually in the form of `usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469`. Legacy players can have old IDs in the form of `8JoV9XEdpo`. The ID can never be changed.  # noqa: E501

        :param user_id: The user_id of this ProductListingAttributionCreator.  # noqa: E501
        :type user_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductListingAttributionCreator):
            return False
