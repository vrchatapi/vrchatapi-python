...
class LimitedUser(object):
    ...
    def __init__(self, bio=None, bio_links=None, current_avatar_image_url=None, current_avatar_thumbnail_image_url=None, current_avatar_tags=None, developer_type=None, display_name=None, fallback_avatar=None, id=None, is_friend=None, last_platform=None, profile_pic_override=None, pronouns=None, status=None, status_description=None, tags=None, user_icon=None, username=None, location=None, friend_key=None, local_vars_configuration=None):  # noqa: E501
