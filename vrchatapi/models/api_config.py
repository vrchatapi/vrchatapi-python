...
class APIConfig(object):
    ...
    openapi_types = {
        ...
        'economy_state': 'int',
        'enable_vrc_plus_world_lists': 'bool',
        'event_shelf_campaigns': 'list[APIConfigEventShelfCampaign]',
        'events': 'APIConfigEvents',
        'force_use_latest_world': 'bool',
        'gift_display_type': 'str',
        'global_cache_version': 'int',
        'global_cache_version_default': 'int',
        'google_api_client_id': 'str',
        'google_api_unity_client_id': 'str',
        'home_world_id': 'str',
        ...
        'jobs_email': 'str',
        'loading_screen_weights': 'dict(str, APIConfigLoadingScreenWeights)',
        'low_memory_go_home_timeout': 'dict(str, APIConfigLowMemoryGoHomeTimeoutValue)',
        'max_user_emoji': 'int',
        'max_user_stickers': 'int',
        'maximum_unity_version_for_uploads': 'str',
        ...
        'player_url_resolver_sha1_gfn_override': 'str',
        'player_url_resolver_version': 'str',
        'player_url_resolver_version_gfn_override': 'str',
        'profile_defaults': 'APIConfigProfileDefaults',
        'prop_component_list': 'list[str]',
        'public_key': 'str',
        'quest_minimum_low_memory_threshold': 'dict(str, int)',
        ...
        'voice_max_playback_sources_mobile': 'int',
        'voice_max_playback_sources_pc': 'int',
    ...
    attribute_map = {
        ...
        'client_max_datagrams': 'clientMaxDatagrams',
        ...
        'enable_vrc_plus_world_lists': 'enableVRCPlusWorldLists',
        'event_shelf_campaigns': 'eventShelfCampaigns',
        'events': 'events',
        'force_use_latest_world': 'forceUseLatestWorld',
        'gift_display_type': 'giftDisplayType',
        'global_cache_version': 'globalCacheVersion',
        'global_cache_version_default': 'globalCacheVersionDefault',
        'google_api_client_id': 'googleApiClientId',
        'google_api_unity_client_id': 'googleApiUnityClientId',
        ...
        'loading_screen_weights': 'loadingScreenWeights',
        'low_memory_go_home_timeout': 'lowMemoryGoHomeTimeout',
        'max_user_emoji': 'maxUserEmoji',
        'max_user_stickers': 'maxUserStickers',
        'maximum_unity_version_for_uploads': 'maximumUnityVersionForUploads',
        ...
        'player_url_resolver_sha1_gfn_override': 'player-url-resolver-sha1-gfn-override',
        'player_url_resolver_version': 'player-url-resolver-version',
        'player_url_resolver_version_gfn_override': 'player-url-resolver-version-gfn-override',
        'profile_defaults': 'profileDefaults',
        'prop_component_list': 'propComponentList',
        'public_key': 'publicKey',
        'quest_minimum_low_memory_threshold': 'questMinimumLowMemoryThreshold',
        ...
        'voice_max_playback_sources_mobile': 'voiceMaxPlaybackSourcesMobile',
        'voice_max_playback_sources_pc': 'voiceMaxPlaybackSourcesPC',
    ...
    def __init__(self, campaign_status=None, disable_background_preloads=True, location_gifting_non_sub_prio_enabled=True, voice_enable_degradation=False, voice_enable_receiver_limiting=True, access_logs_urls=None, address=None, age_verification_invite_visible=None, age_verification_p=None, age_verification_status_visible=None, analysis_max_retries=None, analysis_retry_interval=None, analytics_segment_new_ui_pct_of_users=None, analytics_segment_new_ui_salt=None, announcements=None, audio_config=None, available_language_codes=None, available_languages=None, avatar_perf_limiter=None, chatbox_log_buffer_seconds=40, client_api_key=None, client_bps_ceiling=18432, client_disconnect_timeout=30000, client_max_datagrams=None, client_net_dispatch_thread=False, client_net_dispatch_thread_mobile=True, client_net_in_thread=False, client_net_in_thread2=False, client_net_in_thread_mobile=False, client_net_in_thread_mobile2=False, client_net_out_thread=False, client_net_out_thread2=False, client_net_out_thread_mobile=False, client_net_out_thread_mobile2=False, client_qr=1, client_reserved_player_bps=7168, client_sent_count_allowance=15, client_use_ack2=None, constants=None, contact_email=None, copyright_email=None, copyright_form_url=None, current_privacy_version=1, current_tos_version=None, default_avatar=None, default_sticker_set=None, dev_language_codes=None, dev_sdk_url=None, dev_sdk_version=None, dis_countdown=None, disable_av_pro_in_proton=False, disable_avatar_copying=False, disable_avatar_gating=False, disable_captcha=True, disable_community_labs=False, disable_community_labs_promotion=False, disable_email=False, disable_event_stream=False, disable_feedback_gating=False, disable_frontend_builds=False, disable_gift_drops=False, disable_hello=False, disable_oculus_subs=False, disable_registration=False, disable_steam_networking=True, disable_two_factor_auth=False, disable_udon=False, disable_upgrade_account=False, download_link_windows=None, download_urls=None, dynamic_world_rows=None, economy_ledger_backfill=None, economy_ledger_migration_stop=None, economy_ledger_mode=None, economy_pause_end=None, economy_pause_start=None, economy_purchase_repair_enabled=None, economy_state=1, enable_vrc_plus_world_lists=None, event_shelf_campaigns=None, events=None, force_use_latest_world=True, gift_display_type=None, global_cache_version=None, global_cache_version_default=None, google_api_client_id='827942544393-r2ouvckvouldn9dg9uruseje575e878f.apps.googleusercontent.com', google_api_unity_client_id=None, home_world_id=None, homepage_redirect_target='https://hello.vrchat.com', hub_world_id=None, image_host_url_list=None, ios_app_version=None, ios_version=None, jobs_email=None, loading_screen_weights=None, low_memory_go_home_timeout=None, max_user_emoji=18, max_user_stickers=18, maximum_unity_version_for_uploads=None, min_supported_client_build_number=None, minimum_unity_version_for_uploads='2019.0.0f1', moderation_email=None, not_allowed_to_select_avatar_in_private_world_message=None, offline_analysis=None, photon_nameserver_overrides=None, photon_public_keys=None, player_url_resolver_sha1=None, player_url_resolver_sha1_gfn_override=None, player_url_resolver_version=None, player_url_resolver_version_gfn_override=None, profile_defaults=None, prop_component_list=None, public_key=None, quest_minimum_low_memory_threshold=None, report_categories=None, report_form_url='https://help.vrchat.com/hc/en-us/requests/new?ticket_form_id=1500000182242&tf_360056455174=user_report&tf_360057451993={userId}&tf_1500001445142={reportedId}&tf_subject={reason} {category} By {contentType} {reportedName}&tf_description={description}', report_options=None, report_reasons=None, require_age_verification_beta_tag=None, sdk_developer_faq_url=None, sdk_discord_url=None, sdk_not_allowed_to_publish_message=None, sdk_unity_version=None, string_host_url_list=None, support_email=None, support_form_url=None, time_out_world_id=None, timekeeping=True, tutorial_world_id=None, update_rate_ms_maximum=None, update_rate_ms_minimum=None, update_rate_ms_normal=None, update_rate_ms_udon_manual=None, upload_analysis_percent=None, url_list=None, use_reliable_udp_for_voice=False, vive_windows_url=None, voice_max_playback_sources_mobile=None, voice_max_playback_sources_pc=None, websocket_max_friends_refresh_delay=900, websocket_quick_reconnect_time=2, websocket_reconnect_max_delay=2, white_listed_asset_urls=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._client_max_datagrams = None
        ...
        self._enable_vrc_plus_world_lists = None
        self._event_shelf_campaigns = None
        self._events = None
        self._force_use_latest_world = None
        self._gift_display_type = None
        self._global_cache_version = None
        self._global_cache_version_default = None
        self._google_api_client_id = None
        self._google_api_unity_client_id = None
        ...
        self._loading_screen_weights = None
        self._low_memory_go_home_timeout = None
        self._max_user_emoji = None
        self._max_user_stickers = None
        self._maximum_unity_version_for_uploads = None
        ...
        self._player_url_resolver_sha1_gfn_override = None
        self._player_url_resolver_version = None
        self._player_url_resolver_version_gfn_override = None
        self._profile_defaults = None
        self._prop_component_list = None
        self._public_key = None
        self._quest_minimum_low_memory_threshold = None
        ...
        self._voice_max_playback_sources_mobile = None
        self._voice_max_playback_sources_pc = None
        ...
        if client_max_datagrams is not None:
            self.client_max_datagrams = client_max_datagrams
        ...
        if client_use_ack2 is not None:
            self.client_use_ack2 = client_use_ack2
        ...
        if enable_vrc_plus_world_lists is not None:
            self.enable_vrc_plus_world_lists = enable_vrc_plus_world_lists
        if event_shelf_campaigns is not None:
            self.event_shelf_campaigns = event_shelf_campaigns
        self.events = events
        self.force_use_latest_world = force_use_latest_world
        self.gift_display_type = gift_display_type
        if global_cache_version is not None:
            self.global_cache_version = global_cache_version
        if global_cache_version_default is not None:
            self.global_cache_version_default = global_cache_version_default
        self.google_api_client_id = google_api_client_id
        if google_api_unity_client_id is not None:
            self.google_api_unity_client_id = google_api_unity_client_id
        ...
        if loading_screen_weights is not None:
            self.loading_screen_weights = loading_screen_weights
        if low_memory_go_home_timeout is not None:
            self.low_memory_go_home_timeout = low_memory_go_home_timeout
        self.max_user_emoji = max_user_emoji
        self.max_user_stickers = max_user_stickers
        if maximum_unity_version_for_uploads is not None:
            self.maximum_unity_version_for_uploads = maximum_unity_version_for_uploads
        ...
        if player_url_resolver_sha1_gfn_override is not None:
            self.player_url_resolver_sha1_gfn_override = player_url_resolver_sha1_gfn_override
        self.player_url_resolver_version = player_url_resolver_version
        if player_url_resolver_version_gfn_override is not None:
            self.player_url_resolver_version_gfn_override = player_url_resolver_version_gfn_override
        if profile_defaults is not None:
            self.profile_defaults = profile_defaults
        if prop_component_list is not None:
            self.prop_component_list = prop_component_list
        self.public_key = public_key
        if quest_minimum_low_memory_threshold is not None:
            self.quest_minimum_low_memory_threshold = quest_minimum_low_memory_threshold
        ...
        if voice_max_playback_sources_mobile is not None:
            self.voice_max_playback_sources_mobile = voice_max_playback_sources_mobile
        if voice_max_playback_sources_pc is not None:
            self.voice_max_playback_sources_pc = voice_max_playback_sources_pc
    ...
    @property
    def client_max_datagrams(self):
        """Gets the client_max_datagrams of this APIConfig.  # noqa: E501


        :return: The client_max_datagrams of this APIConfig.  # noqa: E501
        :rtype: int
        """
        return self._client_max_datagrams

    @client_max_datagrams.setter
    def client_max_datagrams(self, client_max_datagrams):
        """Sets the client_max_datagrams of this APIConfig.


        :param client_max_datagrams: The client_max_datagrams of this APIConfig.  # noqa: E501
        :type client_max_datagrams: int
        """

        self._client_max_datagrams = client_max_datagrams
    ...
    @property
    def client_use_ack2(self):
        """Gets the client_use_ack2 of this APIConfig.  # noqa: E501


        :return: The client_use_ack2 of this APIConfig.  # noqa: E501
        :rtype: bool
        """
        return self._client_use_ack2

    @client_use_ack2.setter
    def client_use_ack2(self, client_use_ack2):
        """Sets the client_use_ack2 of this APIConfig.


        :param client_use_ack2: The client_use_ack2 of this APIConfig.  # noqa: E501
        :type client_use_ack2: bool
        """

        self._client_use_ack2 = client_use_ack2
    ...
    @property
    def enable_vrc_plus_world_lists(self):
        """Gets the enable_vrc_plus_world_lists of this APIConfig.  # noqa: E501


        :return: The enable_vrc_plus_world_lists of this APIConfig.  # noqa: E501
        :rtype: bool
        """
        return self._enable_vrc_plus_world_lists

    @enable_vrc_plus_world_lists.setter
    def enable_vrc_plus_world_lists(self, enable_vrc_plus_world_lists):
        """Sets the enable_vrc_plus_world_lists of this APIConfig.


        :param enable_vrc_plus_world_lists: The enable_vrc_plus_world_lists of this APIConfig.  # noqa: E501
        :type enable_vrc_plus_world_lists: bool
        """

        self._enable_vrc_plus_world_lists = enable_vrc_plus_world_lists

    @property
    def event_shelf_campaigns(self):
        """Gets the event_shelf_campaigns of this APIConfig.  # noqa: E501


        :return: The event_shelf_campaigns of this APIConfig.  # noqa: E501
        :rtype: list[APIConfigEventShelfCampaign]
        """
        return self._event_shelf_campaigns

    @event_shelf_campaigns.setter
    def event_shelf_campaigns(self, event_shelf_campaigns):
        """Sets the event_shelf_campaigns of this APIConfig.


        :param event_shelf_campaigns: The event_shelf_campaigns of this APIConfig.  # noqa: E501
        :type event_shelf_campaigns: list[APIConfigEventShelfCampaign]
        """

        self._event_shelf_campaigns = event_shelf_campaigns
    ...
    @property
    def global_cache_version(self):
        """Gets the global_cache_version of this APIConfig.  # noqa: E501


        :return: The global_cache_version of this APIConfig.  # noqa: E501
        :rtype: int
        """
        return self._global_cache_version

    @global_cache_version.setter
    def global_cache_version(self, global_cache_version):
        """Sets the global_cache_version of this APIConfig.


        :param global_cache_version: The global_cache_version of this APIConfig.  # noqa: E501
        :type global_cache_version: int
        """

        self._global_cache_version = global_cache_version

    @property
    def global_cache_version_default(self):
        """Gets the global_cache_version_default of this APIConfig.  # noqa: E501


        :return: The global_cache_version_default of this APIConfig.  # noqa: E501
        :rtype: int
        """
        return self._global_cache_version_default

    @global_cache_version_default.setter
    def global_cache_version_default(self, global_cache_version_default):
        """Sets the global_cache_version_default of this APIConfig.


        :param global_cache_version_default: The global_cache_version_default of this APIConfig.  # noqa: E501
        :type global_cache_version_default: int
        """

        self._global_cache_version_default = global_cache_version_default
    ...
    @property
    def google_api_unity_client_id(self):
        """Gets the google_api_unity_client_id of this APIConfig.  # noqa: E501


        :return: The google_api_unity_client_id of this APIConfig.  # noqa: E501
        :rtype: str
        """
        return self._google_api_unity_client_id

    @google_api_unity_client_id.setter
    def google_api_unity_client_id(self, google_api_unity_client_id):
        """Sets the google_api_unity_client_id of this APIConfig.


        :param google_api_unity_client_id: The google_api_unity_client_id of this APIConfig.  # noqa: E501
        :type google_api_unity_client_id: str
        """

        self._google_api_unity_client_id = google_api_unity_client_id
    ...
    @property
    def loading_screen_weights(self):
        """Gets the loading_screen_weights of this APIConfig.  # noqa: E501

        Relative weight of each info-push category on the loading screen, per audience.  # noqa: E501

        :return: The loading_screen_weights of this APIConfig.  # noqa: E501
        :rtype: dict(str, APIConfigLoadingScreenWeights)
        """
        return self._loading_screen_weights

    @loading_screen_weights.setter
    def loading_screen_weights(self, loading_screen_weights):
        """Sets the loading_screen_weights of this APIConfig.

        Relative weight of each info-push category on the loading screen, per audience.  # noqa: E501

        :param loading_screen_weights: The loading_screen_weights of this APIConfig.  # noqa: E501
        :type loading_screen_weights: dict(str, APIConfigLoadingScreenWeights)
        """

        self._loading_screen_weights = loading_screen_weights

    @property
    def low_memory_go_home_timeout(self):
        """Gets the low_memory_go_home_timeout of this APIConfig.  # noqa: E501

        Low-memory timeout, keyed by platform.  # noqa: E501

        :return: The low_memory_go_home_timeout of this APIConfig.  # noqa: E501
        :rtype: dict(str, APIConfigLowMemoryGoHomeTimeoutValue)
        """
        return self._low_memory_go_home_timeout

    @low_memory_go_home_timeout.setter
    def low_memory_go_home_timeout(self, low_memory_go_home_timeout):
        """Sets the low_memory_go_home_timeout of this APIConfig.

        Low-memory timeout, keyed by platform.  # noqa: E501

        :param low_memory_go_home_timeout: The low_memory_go_home_timeout of this APIConfig.  # noqa: E501
        :type low_memory_go_home_timeout: dict(str, APIConfigLowMemoryGoHomeTimeoutValue)
        """

        self._low_memory_go_home_timeout = low_memory_go_home_timeout
    ...
    @property
    def maximum_unity_version_for_uploads(self):
        """Gets the maximum_unity_version_for_uploads of this APIConfig.  # noqa: E501


        :return: The maximum_unity_version_for_uploads of this APIConfig.  # noqa: E501
        :rtype: str
        """
        return self._maximum_unity_version_for_uploads

    @maximum_unity_version_for_uploads.setter
    def maximum_unity_version_for_uploads(self, maximum_unity_version_for_uploads):
        """Sets the maximum_unity_version_for_uploads of this APIConfig.


        :param maximum_unity_version_for_uploads: The maximum_unity_version_for_uploads of this APIConfig.  # noqa: E501
        :type maximum_unity_version_for_uploads: str
        """

        self._maximum_unity_version_for_uploads = maximum_unity_version_for_uploads
    ...
    @property
    def player_url_resolver_sha1_gfn_override(self):
        """Gets the player_url_resolver_sha1_gfn_override of this APIConfig.  # noqa: E501

        Overrides `player-url-resolver-sha1` on GeForce Now.  # noqa: E501

        :return: The player_url_resolver_sha1_gfn_override of this APIConfig.  # noqa: E501
        :rtype: str
        """
        return self._player_url_resolver_sha1_gfn_override

    @player_url_resolver_sha1_gfn_override.setter
    def player_url_resolver_sha1_gfn_override(self, player_url_resolver_sha1_gfn_override):
        """Sets the player_url_resolver_sha1_gfn_override of this APIConfig.

        Overrides `player-url-resolver-sha1` on GeForce Now.  # noqa: E501

        :param player_url_resolver_sha1_gfn_override: The player_url_resolver_sha1_gfn_override of this APIConfig.  # noqa: E501
        :type player_url_resolver_sha1_gfn_override: str
        """

        self._player_url_resolver_sha1_gfn_override = player_url_resolver_sha1_gfn_override
    ...
    @property
    def player_url_resolver_version_gfn_override(self):
        """Gets the player_url_resolver_version_gfn_override of this APIConfig.  # noqa: E501

        Overrides `player-url-resolver-version` on GeForce Now.  # noqa: E501

        :return: The player_url_resolver_version_gfn_override of this APIConfig.  # noqa: E501
        :rtype: str
        """
        return self._player_url_resolver_version_gfn_override

    @player_url_resolver_version_gfn_override.setter
    def player_url_resolver_version_gfn_override(self, player_url_resolver_version_gfn_override):
        """Sets the player_url_resolver_version_gfn_override of this APIConfig.

        Overrides `player-url-resolver-version` on GeForce Now.  # noqa: E501

        :param player_url_resolver_version_gfn_override: The player_url_resolver_version_gfn_override of this APIConfig.  # noqa: E501
        :type player_url_resolver_version_gfn_override: str
        """

        self._player_url_resolver_version_gfn_override = player_url_resolver_version_gfn_override

    @property
    def profile_defaults(self):
        """Gets the profile_defaults of this APIConfig.  # noqa: E501


        :return: The profile_defaults of this APIConfig.  # noqa: E501
        :rtype: APIConfigProfileDefaults
        """
        return self._profile_defaults

    @profile_defaults.setter
    def profile_defaults(self, profile_defaults):
        """Sets the profile_defaults of this APIConfig.


        :param profile_defaults: The profile_defaults of this APIConfig.  # noqa: E501
        :type profile_defaults: APIConfigProfileDefaults
        """

        self._profile_defaults = profile_defaults

    @property
    def prop_component_list(self):
        """Gets the prop_component_list of this APIConfig.  # noqa: E501

        SDK3 component type names.  # noqa: E501

        :return: The prop_component_list of this APIConfig.  # noqa: E501
        :rtype: list[str]
        """
        return self._prop_component_list

    @prop_component_list.setter
    def prop_component_list(self, prop_component_list):
        """Sets the prop_component_list of this APIConfig.

        SDK3 component type names.  # noqa: E501

        :param prop_component_list: The prop_component_list of this APIConfig.  # noqa: E501
        :type prop_component_list: list[str]
        """

        self._prop_component_list = prop_component_list
    ...
    @property
    def quest_minimum_low_memory_threshold(self):
        """Gets the quest_minimum_low_memory_threshold of this APIConfig.  # noqa: E501

        Low-memory threshold, keyed by platform.  # noqa: E501

        :return: The quest_minimum_low_memory_threshold of this APIConfig.  # noqa: E501
        :rtype: dict(str, int)
        """
        return self._quest_minimum_low_memory_threshold

    @quest_minimum_low_memory_threshold.setter
    def quest_minimum_low_memory_threshold(self, quest_minimum_low_memory_threshold):
        """Sets the quest_minimum_low_memory_threshold of this APIConfig.

        Low-memory threshold, keyed by platform.  # noqa: E501

        :param quest_minimum_low_memory_threshold: The quest_minimum_low_memory_threshold of this APIConfig.  # noqa: E501
        :type quest_minimum_low_memory_threshold: dict(str, int)
        """

        self._quest_minimum_low_memory_threshold = quest_minimum_low_memory_threshold
    ...
    @property
    def voice_max_playback_sources_mobile(self):
        """Gets the voice_max_playback_sources_mobile of this APIConfig.  # noqa: E501


        :return: The voice_max_playback_sources_mobile of this APIConfig.  # noqa: E501
        :rtype: int
        """
        return self._voice_max_playback_sources_mobile

    @voice_max_playback_sources_mobile.setter
    def voice_max_playback_sources_mobile(self, voice_max_playback_sources_mobile):
        """Sets the voice_max_playback_sources_mobile of this APIConfig.


        :param voice_max_playback_sources_mobile: The voice_max_playback_sources_mobile of this APIConfig.  # noqa: E501
        :type voice_max_playback_sources_mobile: int
        """

        self._voice_max_playback_sources_mobile = voice_max_playback_sources_mobile

    @property
    def voice_max_playback_sources_pc(self):
        """Gets the voice_max_playback_sources_pc of this APIConfig.  # noqa: E501


        :return: The voice_max_playback_sources_pc of this APIConfig.  # noqa: E501
        :rtype: int
        """
        return self._voice_max_playback_sources_pc

    @voice_max_playback_sources_pc.setter
    def voice_max_playback_sources_pc(self, voice_max_playback_sources_pc):
        """Sets the voice_max_playback_sources_pc of this APIConfig.


        :param voice_max_playback_sources_pc: The voice_max_playback_sources_pc of this APIConfig.  # noqa: E501
        :type voice_max_playback_sources_pc: int
        """

        self._voice_max_playback_sources_pc = voice_max_playback_sources_pc
