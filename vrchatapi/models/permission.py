...
class Permission(object):
    ...
    def __init__(self, data=None, description=None, display_name=None, id=None, name=None, owner_display_name=None, owner_id=None, type=None, local_vars_configuration=None):  # noqa: E501
