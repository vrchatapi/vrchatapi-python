...
class FileAnalysisAvatarStats(object):
    ...
    @property
    def raycast_count(self):
        """Gets the raycast_count of this FileAnalysisAvatarStats.  # noqa: E501


        :return: The raycast_count of this FileAnalysisAvatarStats.  # noqa: E501
        :rtype: int
        """
        return self._raycast_count

    @raycast_count.setter
    def raycast_count(self, raycast_count):
        """Sets the raycast_count of this FileAnalysisAvatarStats.


        :param raycast_count: The raycast_count of this FileAnalysisAvatarStats.  # noqa: E501
        :type raycast_count: int
        """

        self._raycast_count = raycast_count
