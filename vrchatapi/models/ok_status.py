...
class OkStatus(object):
    ...
    def __init__(self, ok='maybe?', local_vars_configuration=None):  # noqa: E501
        """OkStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def ok(self):
        """Gets the ok of this OkStatus.  # noqa: E501

        The actual status itself  # noqa: E501

        :return: The ok of this OkStatus.  # noqa: E501
        :rtype: str
        """
        return self._ok
    ...
    @ok.setter
    def ok(self, ok):
        """Sets the ok of this OkStatus.

        The actual status itself  # noqa: E501

        :param ok: The ok of this OkStatus.  # noqa: E501
        :type ok: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OkStatus):
            return False
