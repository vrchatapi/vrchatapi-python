...
def lazy_import():
    ...
    globals()['FavoriteID'] = FavoriteID
    globals()['FavoriteType'] = FavoriteType
    globals()['Tag'] = Tag


class Favorite(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, favorite_id, tags, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, type, favorite_id, tags, *args, **kwargs):  # noqa: E501
        """Favorite - a model defined in OpenAPI
