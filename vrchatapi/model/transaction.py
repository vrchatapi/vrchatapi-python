...
def lazy_import():
    ...
    globals()['TransactionAgreement'] = TransactionAgreement
    globals()['TransactionID'] = TransactionID
    globals()['TransactionStatus'] = TransactionStatus
    globals()['TransactionSteamInfo'] = TransactionSteamInfo
...
class Transaction(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'error': (str,),  # noqa: E501
            'steam': (TransactionSteamInfo,),  # noqa: E501
            'agreement': (TransactionAgreement,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, status, subscription, created_at, updated_at, error, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            sandbox (bool): defaults to False  # noqa: E501
            ...
            steam (TransactionSteamInfo): [optional]  # noqa: E501
            agreement (TransactionAgreement): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, status, subscription, created_at, updated_at, error, *args, **kwargs):  # noqa: E501
        """Transaction - a model defined in OpenAPI
