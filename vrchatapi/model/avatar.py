...
class Avatar(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, author_id, description, id, image_url, name, release_status, tags, thumbnail_image_url, unity_package_url, unity_package_url_object, unity_packages, updated_at, *args, **kwargs):  # noqa: E501
        """Avatar - a model defined in OpenAPI
