...
class PastDisplayName(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, display_name, updated_at, *args, **kwargs):  # noqa: E501
        """PastDisplayName - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, display_name, updated_at, *args, **kwargs):  # noqa: E501
        """PastDisplayName - a model defined in OpenAPI
