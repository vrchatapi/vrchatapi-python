...
def lazy_import():
    ...
    globals()['FileVersion'] = FileVersion
    globals()['MIMEType'] = MIMEType
    globals()['Tag'] = Tag
...
class File(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tags': ([Tag],),  # noqa: E501
            'versions': ([FileVersion],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, owner_id, mime_type, extension, tags, versions, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, mime_type, extension, tags, versions, *args, **kwargs):  # noqa: E501
        """File - a model defined in OpenAPI
