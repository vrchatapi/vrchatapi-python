...
class File(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, extension, id, mime_type, name, owner_id, tags, versions, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, extension, id, mime_type, name, owner_id, tags, versions, *args, **kwargs):  # noqa: E501
        """File - a model defined in OpenAPI
