...
class InlineResponse2004(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'next_part_number': (float,),  # noqa: E501
            'max_parts': (float,),  # noqa: E501
            'parts': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
            'etags': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, upload_id, file_name, next_part_number, max_parts, parts, etags, *args, **kwargs):  # noqa: E501
