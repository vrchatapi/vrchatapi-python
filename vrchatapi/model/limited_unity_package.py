...
class LimitedUnityPackage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, platform, unity_version, *args, **kwargs):  # noqa: E501
        """LimitedUnityPackage - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, platform, unity_version, *args, **kwargs):  # noqa: E501
        """LimitedUnityPackage - a model defined in OpenAPI
