...
class FileData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, file_name, url, md5, size_in_bytes, status, category, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            upload_id (str): defaults to ""  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, file_name, url, md5, size_in_bytes, status, *args, **kwargs):  # noqa: E501
        """FileData - a model defined in OpenAPI
