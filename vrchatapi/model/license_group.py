...
class LicenseGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, description, licenses, *args, **kwargs):  # noqa: E501
        """LicenseGroup - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, description, licenses, *args, **kwargs):  # noqa: E501
        """LicenseGroup - a model defined in OpenAPI
