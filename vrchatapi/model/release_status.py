...
class ReleaseStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "public", must be one of ["public", "private", "hidden", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "public", must be one of ["public", "private", "hidden", ]  # noqa: E501
