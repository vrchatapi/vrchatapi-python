...
class LimitedUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, username, display_name, user_icon, profile_pic_override, status_description, current_avatar_image_url, current_avatar_thumbnail_image_url, fallback_avatar, developer_type, last_platform, status, is_friend, location, tags, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, username, display_name, user_icon, profile_pic_override, status_description, current_avatar_image_url, current_avatar_thumbnail_image_url, fallback_avatar, developer_type, last_platform, status, is_friend, location, tags, *args, **kwargs):  # noqa: E501
        """LimitedUser - a model defined in OpenAPI
