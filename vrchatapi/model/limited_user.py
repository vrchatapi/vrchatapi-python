...
class LimitedUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, current_avatar_image_url, current_avatar_thumbnail_image_url, developer_type, display_name, fallback_avatar, id, is_friend, last_platform, profile_pic_override, status, status_description, tags, user_icon, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, current_avatar_image_url, current_avatar_thumbnail_image_url, developer_type, display_name, fallback_avatar, id, is_friend, last_platform, profile_pic_override, status, status_description, tags, user_icon, *args, **kwargs):  # noqa: E501
        """LimitedUser - a model defined in OpenAPI
