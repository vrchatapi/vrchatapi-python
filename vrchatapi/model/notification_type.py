...
class NotificationType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["all", "broadcast", "friendRequest", "invite", "message", "RequestInvite", "votetokick", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["all", "broadcast", "friendRequest", "invite", "message", "RequestInvite", "votetokick", ]  # noqa: E501
