...
class InlineResponse2002(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ok, server_name, build_version_tag, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, ok, server_name, build_version_tag, *args, **kwargs):  # noqa: E501
        """InlineResponse2002 - a model defined in OpenAPI
