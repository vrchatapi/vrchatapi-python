...
class User(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, allow_avatar_copying, bio, bio_links, current_avatar_image_url, current_avatar_thumbnail_image_url, developer_type, display_name, friend_key, id, instance_id, is_friend, last_login, last_platform, location, profile_pic_override, state, status, status_description, tags, user_icon, username, world_id, *args, **kwargs):  # noqa: E501
        """User - a model defined in OpenAPI
