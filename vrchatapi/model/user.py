...
class User(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, username, display_name, user_icon, bio, bio_links, profile_pic_override, status_description, current_avatar_image_url, current_avatar_thumbnail_image_url, state, tags, developer_type, last_login, last_platform, allow_avatar_copying, status, date_joined, is_friend, friend_key, world_id, instance_id, location, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, username, display_name, user_icon, bio, bio_links, profile_pic_override, status_description, current_avatar_image_url, current_avatar_thumbnail_image_url, state, tags, developer_type, last_login, last_platform, allow_avatar_copying, status, is_friend, friend_key, world_id, instance_id, location, *args, **kwargs):  # noqa: E501
        """User - a model defined in OpenAPI
