...
class Subscription(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, steam_item_id, amount, description, period, tier, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, steam_item_id, amount, description, period, tier, *args, **kwargs):  # noqa: E501
        """Subscription - a model defined in OpenAPI
