...
def lazy_import():
    ...
    globals()['InfoPushData'] = InfoPushData
    globals()['ReleaseStatus'] = ReleaseStatus
    globals()['Tag'] = Tag


class InfoPush(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, release_status, priority, tags, data, hash, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """InfoPush - a model defined in OpenAPI
        ...
        Keyword Args:
            is_enabled (bool): defaults to True  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, release_status, priority, tags, data, hash, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """InfoPush - a model defined in OpenAPI
