...
class Instance(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, capacity, client_number, id, instance_id, location, n_users, name, photon_region, platforms, region, short_name, tags, type, world_id, *args, **kwargs):  # noqa: E501
        """Instance - a model defined in OpenAPI
