...
class Instance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, capacity, client_number, id, instance_id, location, n_users, name, photon_region, platforms, region, short_name, tags, type, world_id, *args, **kwargs):  # noqa: E501
