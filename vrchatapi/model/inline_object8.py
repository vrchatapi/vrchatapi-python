...
class InlineObject8(ModelNormal):
    ...
    attribute_map = {
        'type': 'type',  # noqa: E501
        'favorite_id': 'favoriteId',  # noqa: E501
        'tags': 'tags',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, favorite_id, tags, *args, **kwargs):  # noqa: E501
        """InlineObject8 - a model defined in OpenAPI

        Args:
            type (FavoriteType):
            favorite_id (str): Must be either AvatarID, WorldID or UserID.
            tags ([Tag]): Tags indicate which group this favorite belongs to. Adding multiple groups makes it show up in all. Removing it from one in that case removes it from all.
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, favorite_id, tags, *args, **kwargs):  # noqa: E501
        """InlineObject8 - a model defined in OpenAPI
