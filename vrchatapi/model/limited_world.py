...
class LimitedWorld(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, author_id, author_name, capacity, image_url, thumbnail_image_url, release_status, organization, tags, favorites, created_at, updated_at, publication_date, labs_publication_date, unity_packages, popularity, heat, occupants, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, author_id, author_name, capacity, image_url, thumbnail_image_url, release_status, organization, tags, favorites, created_at, updated_at, labs_publication_date, unity_packages, popularity, heat, occupants, *args, **kwargs):  # noqa: E501
        """LimitedWorld - a model defined in OpenAPI
