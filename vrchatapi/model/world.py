...
class World(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'visits': (float,),  # noqa: E501
            'favorites': (float,),  # noqa: E501
            'instances': ([[{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]],),  # noqa: E501
            'occupants': (float,),  # noqa: E501
            'preview_youtube_id': (str,),  # noqa: E501
            'private_occupants': (float,),  # noqa: E501
            'public_occupants': (float,),  # noqa: E501
        }
    ...
    read_only_vars = {
        ...
        'favorites',  # noqa: E501
        'occupants',  # noqa: E501
        'private_occupants',  # noqa: E501
        'public_occupants',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, asset_url, asset_url_object, author_id, author_name, capacity, created_at, description, id, image_url, labs_publication_date, name, namespace, plugin_url_object, publication_date, release_status, tags, thumbnail_image_url, unity_package_url_object, unity_packages, updated_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            heat (float): defaults to 0  # noqa: E501
            organization (str): defaults to "vrchat"  # noqa: E501
            popularity (float): defaults to 0  # noqa: E501
            version (float): defaults to 0  # noqa: E501
            visits (float): defaults to 0  # noqa: E501
            ...
            favorites (float): [optional] if omitted the server will use the default value of 0  # noqa: E501
            instances ([[{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]]): [optional]  # noqa: E501
            occupants (float): [optional] if omitted the server will use the default value of 0  # noqa: E501
            preview_youtube_id (str): [optional]  # noqa: E501
            private_occupants (float): [optional] if omitted the server will use the default value of 0  # noqa: E501
            public_occupants (float): [optional] if omitted the server will use the default value of 0  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_url, asset_url_object, description, id, image_url, labs_publication_date, name, namespace, plugin_url_object, publication_date, release_status, tags, thumbnail_image_url, unity_package_url_object, unity_packages, updated_at, *args, **kwargs):  # noqa: E501
        """World - a model defined in OpenAPI
