...
class World(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, author_id, author_name, capacity, created_at, description, id, image_url, labs_publication_date, name, namespace, publication_date, release_status, tags, thumbnail_image_url, unity_packages, updated_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            instances ([[bool, date, datetime, dict, float, int, list, str, none_type]]): Will always be an empty list when unauthenticated.. [optional]  # noqa: E501
            occupants (int): Will always be `0` when unauthenticated.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            preview_youtube_id (str, none_type): [optional]  # noqa: E501
            private_occupants (int): Will always be `0` when unauthenticated.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            public_occupants (int): Will always be `0` when unauthenticated.. [optional] if omitted the server will use the default value of 0  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, author_id, author_name, capacity, created_at, description, id, image_url, labs_publication_date, name, namespace, publication_date, release_status, tags, thumbnail_image_url, unity_packages, updated_at, *args, **kwargs):  # noqa: E501
        """World - a model defined in OpenAPI
