...
class World(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, asset_url, asset_url_object, author_id, description, id, image_url, labs_publication_date, name, namespace, plugin_url_object, publication_date, release_status, tags, thumbnail_image_url, unity_package_url_object, unity_packages, updated_at, *args, **kwargs):  # noqa: E501
        """World - a model defined in OpenAPI
