...
class InstancesApi(object):
    ...
    def get_instance_categories(self, **kwargs):  # noqa: E501
        """List Instance Categories  # noqa: E501

        Returns the categories an instance can be listed under.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_instance_categories(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: list[InstanceCategory]
        """
        kwargs['_return_http_data_only'] = True
        return self.get_instance_categories_with_http_info(**kwargs)  # noqa: E501

    def get_instance_categories_with_http_info(self, **kwargs):  # noqa: E501
        """List Instance Categories  # noqa: E501
        ...
        >>> thread = api.get_instance_categories_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[InstanceCategory], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_instance_categories" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        response_types_map = {
            200: "list[InstanceCategory]",
        }

        return self.api_client.call_api(
            '/instanceCategories', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_instance_vibes(self, **kwargs):  # noqa: E501
        """List Instance Vibes  # noqa: E501

        Returns the vibes an instance can be tagged with.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_instance_vibes(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: list[InstanceVibe]
        """
        kwargs['_return_http_data_only'] = True
        return self.get_instance_vibes_with_http_info(**kwargs)  # noqa: E501

    def get_instance_vibes_with_http_info(self, **kwargs):  # noqa: E501
        """List Instance Vibes  # noqa: E501
        ...
        >>> thread = api.get_instance_vibes_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[InstanceVibe], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_instance_vibes" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
