...
class FriendsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_friend_request = _Endpoint(
            settings={
            ...
            callable=__delete_friend_request
        )
        ...
        self.get_friend_status = _Endpoint(
            settings={
