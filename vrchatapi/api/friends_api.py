...
class FriendsApi(object):
    ...
    def boop(self, user_id, boop_request, **kwargs):  # noqa: E501
        """Send Boop  # noqa: E501

        Send a boop to another user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.boop(user_id, boop_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.boop_with_http_info(user_id, boop_request, **kwargs)  # noqa: E501

    def boop_with_http_info(self, user_id, boop_request, **kwargs):  # noqa: E501
        """Send Boop  # noqa: E501
        ...
        >>> thread = api.boop_with_http_info(user_id, boop_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and local_var_params.get('user_id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `user_id` when calling `boop`")  # noqa: E501
        # verify the required parameter 'boop_request' is set
        if self.api_client.client_side_validation and local_var_params.get('boop_request') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `boop_request` when calling `boop`")  # noqa: E501
        ...
        body_params = None
        if 'boop_request' in local_var_params:
            body_params = local_var_params['boop_request']
        # HTTP header `Accept`
