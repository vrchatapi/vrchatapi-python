...
class MiscellaneousApi(object):
    ...
    def get_beta(self, beta_name, **kwargs):  # noqa: E501
        """Get Beta Program  # noqa: E501

        Get a beta program and the fields a registration must supply.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_beta(beta_name, async_req=True)
        >>> result = thread.get()

        :param beta_name: The name of a beta program. (required)
        :type beta_name: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_beta_with_http_info(beta_name, **kwargs)  # noqa: E501

    def get_beta_with_http_info(self, beta_name, **kwargs):  # noqa: E501
        """Get Beta Program  # noqa: E501
        ...
        >>> thread = api.get_beta_with_http_info(beta_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Beta, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_beta" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'beta_name' is set
        if self.api_client.client_side_validation and local_var_params.get('beta_name') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `beta_name` when calling `get_beta`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'beta_name' in local_var_params:
            path_params['betaName'] = local_var_params['beta_name']  # noqa: E501
    ...
    def get_beta_registration(self, beta_name, **kwargs):  # noqa: E501
        """Get Beta Registration  # noqa: E501

        Get the currently authenticated user's registration for a beta program.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_beta_registration(beta_name, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_beta_registration_with_http_info(beta_name, **kwargs)  # noqa: E501

    def get_beta_registration_with_http_info(self, beta_name, **kwargs):  # noqa: E501
        """Get Beta Registration  # noqa: E501
        ...
        >>> thread = api.get_beta_registration_with_http_info(beta_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_beta_registration" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'beta_name' is set
        if self.api_client.client_side_validation and local_var_params.get('beta_name') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `beta_name` when calling `get_beta_registration`")  # noqa: E501
    ...
    def get_frontend_branches(self, **kwargs):  # noqa: E501
        """List Frontend Branches  # noqa: E501

        List the frontend branches the currently authenticated user may switch to.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_frontend_branches(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_frontend_branches_with_http_info(**kwargs)  # noqa: E501

    def get_frontend_branches_with_http_info(self, **kwargs):  # noqa: E501
        """List Frontend Branches  # noqa: E501
        ...
        >>> thread = api.get_frontend_branches_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_frontend_branches" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def get_health(self, **kwargs):  # noqa: E501
        ...
        Gets the overall health status, the server name, and the current build version tag of the API.  VRChat has restricted this endpoint, which now always returns 401 Unauthorized.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_info_push_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('require' in local_var_params and  # noqa: E501
                                                        len(local_var_params['require']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `require` when calling `get_info_push`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('include' in local_var_params and  # noqa: E501
                                                        len(local_var_params['include']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `include` when calling `get_info_push`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
