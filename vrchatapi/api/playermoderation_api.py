...
class PlayermoderationApi(object):
    ...
    def get_player_moderations(self, **kwargs):  # noqa: E501
        ...
        :param source_user_id: Must be valid UserID. Trying to view someone else's moderations results with \"Can't view someone else's player moderations\" error.
    ...
    def get_player_moderations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if local_var_params.get('source_user_id') is not None:  # noqa: E501
            query_params.append(('sourceUserId', local_var_params['source_user_id']))  # noqa: E501
