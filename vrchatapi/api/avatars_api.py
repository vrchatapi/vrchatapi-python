...
class AvatarsApi(object):
    ...
    def get_favorited_avatars_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tag' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `tag` when calling `get_favorited_avatars`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('notag' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `notag` when calling `get_favorited_avatars`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def search_avatars_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tag' in local_var_params and  # noqa: E501
                                                        len(local_var_params['tag']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `tag` when calling `search_avatars`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('notag' in local_var_params and  # noqa: E501
                                                        len(local_var_params['notag']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `notag` when calling `search_avatars`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
